                   ...
                   obj.toolbar.appendChild(toolbarItem);
                     ...
                     jSuites.color(toolbarItem, {
                         onchange:function(o, v) {
                             ...
                             if(obj.highlighted[0].textContent != ''){
                                obj.setStyle(obj.highlighted, k, v);
                                setEstilo(obj.highlighted[0].textContent, k, v);
                                colorirPorNome(obj.highlighted[0].textContent, k, v);
                             }
                         }
                     });
                }
                ...
                if (y == null) {
                    ...
                    if (obj.options.allowInsertRow == true) {
                        items.push({
                            ...
                            onclick:function() {
                                var textBeforeRow = table.getLabel('A'+ConverterPraNumerico(columRevert));
                                obj.insertRow(1, parseInt(y), 1);
                                table.setValue('A'+(+ConverterPraNumerico(columRevert)), textBeforeRow, true);
                            }
                        });
                        ...
                        items.push({
                            ...
                            onclick:function() {
                                var textAfterRow = table.getLabel('A'+ConverterPraNumerico(columRevert));
                                obj.insertRow(1, parseInt(y));
                                table.setValue('A'+(+ConverterPraNumerico(columRevert)+1), textAfterRow, true);
                            }
                        });
                    }
